...
pub const KEY_DC: i32=		0x150;		/* delete-character key */
pub const KEY_IC: i32=		0x151;		/* insert-character key */
pub const KEY_EIC: i32=		0x152;		/* sent by rmir or smir in insert mode */
